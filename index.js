...
function getConfig(isSnapshot) {
    ...
    if (userConfig) {
        configTmpl = extend(configTmpl, userConfig);
    }
...
var maven = {
    ...
    deploy: function (repoId, file, isSnapshot, done) {
        ...
        if (isSnapshot && typeof isSnapshot != 'boolean') {
            done = isSnapshot;
            isSnapshot = false;
        }
